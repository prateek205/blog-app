...
const Register = () => {
  ...
  const { form, setForm, register } = MyAuth();
  ...
  return (
    <section className="h-screen flex items-center justify-center dark:bg-gray-900 dark:text-white">
      <div className="flex itemx-center justify-center flex-col gap-10 shadow-[0_0_10px_rgb(50,50,50)] dark:shadow-[0_0_10px_rgb(250,250,250)] w-80 h-96 rounded-md px-8">
